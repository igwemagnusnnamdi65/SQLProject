<?php
/*******************************************************************************
    crud.php by Igwe Magnus Nnamdi

    CRUD: Create, Read, Update, Delete --  Database example

    Copyright (c) igwe Magnus Nnamdi

    1.1 imn - 2009-04-22 - Updated to work with PHP warnings turned on
    2.0.0 imn -- 2010-08-09 - Support for SQLite
    2.1.0 imn -- 2010-08-17 - Added UDFs for SQLite
    2.2.0 imn -- 2010-08-24 - Public release with support for both SQLite and MySQL
    2.3.0 imn -- 2010-09-04 - Added support for PostgreSQL
    2.2.8 imn -- 2012-01-27 - Public release
